...
- [x] **IoT Hardware Design v2.0** (Documentation)
  - [x] Complete component catalog (9 components)
  - [x] Interactive SVG wiring schematic with color-coded paths
  - [x] Step-by-step connection paths for all sensor groups
  - [x] Power distribution tree diagram
  - [x] GPIO pin mapping with wire colors
  - [x] 8-step assembly guide
  - [x] Updated BOM with pricing
...
| **3.3.0** | March 2026 | Notification & webhook system, forensics API, frontend notifications page, alert dispatcher, IoT hardware design v2.0, 59 backend tests, 186 firmware tests |
