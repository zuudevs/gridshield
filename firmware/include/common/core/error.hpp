...
struct ErrorContext {
    ...
    constexpr ErrorContext(ErrorCode errc_, uint32_t line_ = 0, const char* file_ = nullptr) noexcept
        : code(errc_), line(line_), file(file_) {}
    
    GS_NODISCARD constexpr bool is_critical() const noexcept {
